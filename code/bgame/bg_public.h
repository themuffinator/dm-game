...
#define GTF_CTF			0x0001	// game based on bringing enemy flag to own base, note: not oneflag
#define GTF_FREEZE		0x0002	// players 'freeze' upon death, teammates can 'thaw' them
#define GTF_TEAMBASES	0x0004	// teams spawn at bases
#define GTF_ARENAS		0x0008	// players spawn with full weapon and high ammo count, item spawns disabled
#define GTF_ROUNDS		0x0010	// round based, score by achieving goal limit by round timelimit
#define GTF_TOURNEY		0x0020	// stage based, loser is eliminated
#define GTF_DUEL		0x0040	// 1v1 mode
#define GTF_TEAMS		0x0080	// team based game
#define GTF_CAMPAIGN	0x0100	// campaign mode - monsters, objectives, multi-map
#define GTF_TDM			0x0200	// tdm style rules
#define GTF_DOM			0x0400	// depends on domination points for scoring
#define GTF_BASEOB		0x0800	// uses base obelisks
#define GTF_NEUTOB		0x1000	// uses neutral obelisks

typedef struct bggametypes_s {
	enumGametype	index;			// number for reference
	...
	enumGTLimit		gtGoal;			// primary method for winning the game
